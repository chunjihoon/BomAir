            ...
            <div id="div1">
               <div class="divaa" style="margin-right: 20px; height: 20%;">
                  ...
                  <label>출발지 선택 </label> <select class="selectOptions" id="Depart">
                     ...
                     <optgroup label="국내">
                        <option value="제주" style="width: 100%">제주(CJU)</option>
                     </optgroup>
                     <optgroup label="일본">
                        <option value="도쿄" style="width: 100%">도쿄(NPT)</option>
                        <option value="오사카" style="width: 100%">오사카(KIX)</option>
                        <option value="후쿠오카" style="width: 100%">후쿠오카(FUK)</option>
                     </optgroup>
                     <optgroup label="동남아">
                        <option value="홍콩" style="width: 100%">홍콩(HKG)</option>
                        <option value="방콕" style="width: 100%">방콕(BKK)</option>
                        <option value="코타키나발루" style="width: 100%">코타키나발루(BKI)</option>
                     </optgroup>
                     <optgroup label="그외 지역">
                        <option value="블라디보스토크" style="width: 100%">블라디보스토크(WO)</option>
                        <option value="뉴욕" style="width: 100%">뉴욕(JFK)</option>
                     </optgroup>
                  </select> <br>
               </div>
